...
llm_model = ChatOpenAI(
    ...
    openai_api_base="http://129.154.248.128:8000/v1",
    openai_api_key="FAKE",
    max_tokens=4096,
    temperature=0.1
)
...
def process_folder(tcno):
    try:
        ...
        folder_path = f"/data/txtfolder/dailydocument_10-12-24_txt/{tcno}"
...
def process_folders_in_parallel():
    ...
    base_folder_path = f"/data/txtfolder/dailydocument_10-12-24_txt"
